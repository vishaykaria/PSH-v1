...
import AdminListApprove from './AdminListApprove';
import AdminListDecline from './AdminListDecline';
    ...
    render() {
        ...
        return (
            <div>
                ...
                {
                    type === 'listPublishRequest' && <ListPublishRequest content={content} />
                }
                {
                    type === 'adminListApprove' && <AdminListApprove content={content} />
                }
                {
                    type === 'adminListReject' && <AdminListDecline content={content} />
                }
            </div>
        );
    }
