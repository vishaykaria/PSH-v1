...
class PayoutMethods extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (getPaymentMethods != null && getPaymentMethods.results && getPaymentMethods.results.length > 0
      && (paymentMethodId === undefined || paymentMethodId === null)) {
      const activePayentMethods = getPaymentMethods && getPaymentMethods.results && getPaymentMethods.results.find((o) => o && o.isEnable);
        ...
        <form onSubmit={handleSubmit}>
          <Panel
            ...
            <div className={s.panelBody}>
              ...
              {
                !loading && getPaymentMethods != undefined && getPaymentMethods.results && getPaymentMethods.results.length > 0 && <div className={'payoutTable'}>
              ...
              {
                !loading && getPaymentMethods != undefined && getPaymentMethods.results && getPaymentMethods.results.length === 0 && <div> <FormattedMessage {...messages.noPaymentFound} /> </div>
              }
            </div>
          </Panel>
        </form>
