...
class DetailsForGuest extends React.Component {
  ...
  render() {
    ...
    const { cancelData, cancelData: { cancellationRuleObj: { policyName, accomodation, guestFees, remainingNights, interval, nights, priorDays, nonRefundableNights, cleaningFeePercent } } } = this.props;
