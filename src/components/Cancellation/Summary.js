      ...
      <div>
        ...
        <Row>
          <Col xs={6} sm={6} md={6} lg={6}>
            <div>
              <span className={s.textBold}><FormattedMessage {...messages[interval <= 0 ? 'started' : 'startIn']} /></span><br />
              <span>{interval} {formatMessage(messages[(interval < -1 || interval > 1) ? 'howManydays' : 'howManyday']) + (interval <= 0 ? ' ago' : '')} </span>
            </div>
          </Col>
          <Col xs={6} sm={6} md={6} lg={6}>
