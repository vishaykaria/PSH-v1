...
// Cards Logo Image
import creditCardLogo from '../../../../public/PaymentGateway/credit-card-logos.png';
import poweredByStripe from '../../../../public/PaymentGateway/powered_by_stripe.png';
    ...
    renderField({ input, label, type, placeholder, meta: { touched, error, dirty }, disabled }) {
        ...
        return (
            <FormGroup className={s.formGroup}>
                <FormControl disabled={disabled} {...input} componentClass="input" placeholder={placeholder} className={cx(bt.commonControlInput)} />
                ...
                <div className={s.creditCardFormSection}>
                    <Col md={9} sm={9} xs={12} className={s.noPaddingLeft}>
                        ...
                        <Col md={4} sm={4} xs={4} className={s.noPaddingRight}>
                            <Field disabled={formDisable} name="expiryDate" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.noMargin, s.commonControlSelect)}
                        ...
                        <Col md={4} sm={4} xs={4} className={s.noPaddingRight}>
                            <Field disabled={formDisable} name="expiryYear" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.noMargin, s.commonControlSelect)}
...
export default injectIntl(withStyles(s, bt)(connect(mapState, mapDispatch)(Card)));
