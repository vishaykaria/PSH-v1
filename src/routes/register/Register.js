      ...
      <div className={s.root}>
        <div className={s.container}>
          ...
          <div className={cx(s.formGroup, s.formSection)}>
            <Col xs={12} sm={8} md={8} lg={8} className={cx(s.noPadding, s.textAlignLeft, 'textAlignRightRtl')}>
            ...
            <Col xs={12} sm={4} md={4} lg={4} className={cx(s.noPadding, s.textAlignRight)}>
              <Link className={cx(s.button, bt.btnPrimaryBorder, bt.btnSmall)} to={loginURL}>
