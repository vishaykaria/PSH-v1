    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.container}>
          ...
          {
            getRecommendData && getRecommendData.loading && getImageBannerData.loading && getMostViewedListingData.loading && <div>
              <Loader type="text" />
            </div>
          }
          {
            getRecommendData && !getRecommendData.loading && !getImageBannerData.loading && !getMostViewedListingData.loading && !getStaticBlockInfoData.loading && <div className={s.pageContainer}>
              {
                getRecommendData && getRecommendData.getRecommend && getRecommendData.getRecommend.length > 0 && <div >
                  <h3 className={s.containerTitle}>
                    <FormattedMessage {...messages.recommended} />
                    <SeeAll />
                  </h3>
                  <HomeSlider data={getRecommendData && getRecommendData.getRecommend} />
                </div>
              }
