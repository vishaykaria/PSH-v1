    ...
    return (
      <div className={s.root}>
        <div className={s.container}>
          ...
          <h1><FormattedMessage {...messages.logInLabel} /></h1>
          ...
          <div className={cx(s.formGroup, s.formSection)}>
            <Col xs={12} sm={7} md={7} lg={7} className={cx(s.noPadding, s.textAlignLeft, 'textAlignRightRtl')}>
              <Link className={cx(s.modalCaptionLink, s.modalCaptionLinkLarge)} to={registerURL} >
                <FormattedMessage {...messages.noAccount} />
              </Link>
            </Col>
            <Col xs={12} sm={5} md={5} lg={5} className={cx(s.noPadding, s.textAlignCenter)}>
              <Link className={cx(s.button, bt.btnPrimaryBorder, bt.btnSmall)} to={registerURL} >
