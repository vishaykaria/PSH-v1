...
--
-- Host: localhost    Database: rentall_v_3_2_2
-- ------------------------------------------------------
...
CREATE TABLE `DocumentVerification` (
  ...
  `documentStatus` enum('pending','approved') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `FooterBlock` (
  ...
  `content2` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `title3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content3` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `isEnable` tinyint(1) NOT NULL DEFAULT '1',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `Listing` (
  ...
  `listApprovalStatus` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
INSERT INTO `PaymentMethods` VALUES (1,'Paypal','3–4 hours','PayPal withdrawal fees','USD','Connect your existing PayPal account.',1,'2017-04-18 20:13:25','2017-04-18 20:13:25',1,'PayPal'),(2,'Bank Account','5–7 business days','No fees','USD','Add your bank details',1,'2018-01-04 17:26:45','2018-01-04 17:26:45',2,'Stripe');
...
CREATE TABLE `ReportUser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reporterId` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `User` (
  ...
  `userDeletedBy` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-08-03  1:28:09
