...
const config = {
  ...
  module: {
    ...
    rules: [
      ...
      {
        exclude: [reScript, reStyle, reImage, /\.json$/, /\.txt$/, /\.md$/, /\.(graphql|gql)$/],
        loader: 'file-loader',
        options: {
          name: staticAssetName,
        },
...
const clientConfig = {
  ...
  optimization: {
    moduleIds: 'hashed', // https://v4.webpack.js.org/configuration/optimization/#optimizationmoduleids
    removeAvailableModules: false, // https://webpack.js.org/configuration/optimization/#optimizationremoveavailablemodules
